...
export class Command {
                ...
                for (const file of commandFiles) {
                        try {
                                ...
                                if (command) {
                                        ...
                                        console.log(`\n! ${file} - Invalid command format`);
                                }
                        } catch (err) {
                                console.log(`\nX ${file} - Error loading: ${err.message}`);
                        }
                }
                console.log("\n========================================");
        }
        ...
        generateReadmeContent(projectName, categories, commands) {
                ...
                let content = `# ${projectName} - Discord Commands

> Documentation automatically generated by RaptorJS  
> Last updated: ${now}
                ...
                for (const [categoryName, categoryCommands] of Object.entries(categories)) {
                        ...
                        for (const command of categoryCommands) {
                                ...
                                if (command.permissions && command.permissions.length > 0) {
                                        content += `**Required permissions:** ${command.permissions.join(', ')}\n\n`;
                                }
...
| Command | Description | Category | Cooldown |
|---------|-------------|----------|----------|
`;
...
2. Use commands with the appropriate prefix (slash commands or prefix)
3. Check the usage of each command above

## Development

This bot was developed with **RaptorJS** - Discord Bot Framework

To add a new command:
\`\`\`bash
raptorjs addCommand <command_name>
\`\`\`
...
---
*Documentation automatically generated by RaptorJS v${this.getFrameworkVersion()}*
`;
